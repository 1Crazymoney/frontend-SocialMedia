...
export const CUsersList = () => {
    ...
    const handleSave = async () => {
        const { _id, ...dataToSend } = editingUser; 
        console.log("Data being sent:", dataToSend);
        try {
            const response = await updateUserByAdmin(token, editingUser._id, dataToSend);
            if (response.success) {
    ...
    const handleDelete = async (userId) => {
        try {
            const response = await deleteUserByAdmin(token, userId);
            if (response.success) {
